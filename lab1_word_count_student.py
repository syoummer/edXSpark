...
# TODO: Replace <FILL IN> with appropriate code
uniqueWords = wordsRDD.map(lambda x: (x, 1)).reduceByKey(lambda x, y: 1 + 1).count()
print uniqueWords
...
def removePunctuation(text):
    ...
    return re.sub(r'[^\w\d\s]|_', '', lower_text).strip()
    #import string
    #return lower_text.rep(string.punctuation)
